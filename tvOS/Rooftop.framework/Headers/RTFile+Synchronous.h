...
/**
 This category lists all methods of `RTFile` class that are synchronous, but have asynchronous counterpart,
 ...
 */
- (nullable NSData *)getData RT_SWIFT_UNAVAILABLE;
...
/**
 This method is like `-getData` but avoids ever holding the entire `RTFile` contents in memory at once.
 ...
 */
- (nullable NSInputStream *)getDataStream RT_SWIFT_UNAVAILABLE;
