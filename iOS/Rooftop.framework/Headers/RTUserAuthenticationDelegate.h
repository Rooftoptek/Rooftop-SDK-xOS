...
/**
 Provides a general interface for delegation of third party authentication with `RTUser`s.
 */
@protocol RTUserAuthenticationDelegate <AWSIdentityProviderManager>
