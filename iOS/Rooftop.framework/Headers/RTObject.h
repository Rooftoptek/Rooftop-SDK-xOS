...
@protocol RTSubclassing;
@class RTRelation;
@class RTACL;

/**
 The name of the default pin that for RTObject local data store.
 */
extern NSString *const RTObjectDefaultPin;

/**
 The `RTObject` class is a local representation of data persisted to the Rooftop cloud.
...
///--------------------------------------
#pragma mark - Creating a RTObject
///--------------------------------------

/**
 Initializes a new empty `RTObject` instance with a class name.
...
/**
 Creates a new RTObject with a class name.
...
/**
 Creates a new `RTObject` with a class name, initialized with data
 constructed from the specified set of objects and keys.

 @param className The object's class.
 @param dictionary An `NSDictionary` of keys and objects to set on the new `RTObject`.

 @return A RTObject with the given class name and set with the given data.
 */
...
/**
 ...
 @return A `RTObject` instance without data.
 */
 ...
 */
@property (nonatomic, strong, readonly) NSString *rooftopClassName;
 ...
 */
@property (nullable, nonatomic, strong) RTACL *ACL;
...
/**
 ...
 @param object The object for `key`. A strong reference to the object is maintained by RTObject.
...
/**
 ...
 This method enables usage of literal syntax on `RTObject`.
...
/**
 Returns the instance of `RTRelation` class associated with the given key.

 @param key The key that the relation is associated with.
 */
- (RTRelation *)relationForKey:(NSString *)key;
...
/**
 Saves the `RTObject` *asynchronously*.
...
/**
 Saves the `RTObject` *asynchronously* and executes the given callback block.
...
/**
 ...
 even if Rooftop is currently inaccessible.

 Use this when you may not have a solid network connection, and don't need to know when the save completes.
 If there is some problem with the object such that it can't be saved, it will be silently discarded.

 Objects saved with this method will be stored locally in an on-disk cache until they can be delivered to Rooftop.
 ...
 @return The task that encapsulates the work being done.
 */
- (BFTask<NSNumber *> *)saveEventually RT_TV_UNAVAILABLE RT_WATCH_UNAVAILABLE;
...
/**
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
- (void)saveEventually:(nullable RTBooleanResultBlock)callback RT_TV_UNAVAILABLE RT_WATCH_UNAVAILABLE;
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
+ (BFTask<NSNumber *> *)saveAllInBackground:(nullable NSArray<RTObject *> *)objects;
...
/**
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
+ (void)saveAllInBackground:(nullable NSArray<RTObject *> *)objects
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
+ (BFTask<NSNumber *> *)deleteAllInBackground:(nullable NSArray<RTObject *> *)objects;
...
/**
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
+ (void)deleteAllInBackground:(nullable NSArray<RTObject *> *)objects
                        block:(nullable RTBooleanResultBlock)block;
...
/**
 Gets whether the `RTObject` has been fetched.

 @return `YES` if the RTObject is new or has been fetched or refreshed, otherwise `NO`.
 */
@property (nonatomic, assign, readonly, getter=isDataAvailable) BOOL dataAvailable;

/**
 Fetches the `RTObject` *asynchronously* and sets it as a result for the task.

 @return The task that encapsulates the work being done.
 */
- (BFTask<__kindof RTObject *> *)fetchInBackground;

/**
 Fetches the `RTObject` *asynchronously* and executes the given callback block.

 @param block The block to execute.
 It should have the following argument signature: `^(RTObject *object, NSError *error)`.
 */
- (void)fetchInBackgroundWithBlock:(nullable RTObjectResultBlock)block;

/**
 Fetches the `RTObject` data *asynchronously* if `dataAvailable` is `NO`,
 then sets it as a result for the task.

 @return The task that encapsulates the work being done.
 */
- (BFTask<__kindof RTObject *> *)fetchIfNeededInBackground;

/**
 Fetches the `RTObject` data *asynchronously* if `dataAvailable` is `NO`, then calls the callback block.

 @param block The block to execute.
 It should have the following argument signature: `^(RTObject *object, NSError *error)`.
 */
- (void)fetchIfNeededInBackgroundWithBlock:(nullable RTObjectResultBlock)block;
...
/**
 Fetches all of the `RTObject` objects with the current data from the server *asynchronously*.

 @param objects The list of objects to fetch.

 @return The task that encapsulates the work being done.
 */
+ (BFTask<NSArray<__kindof RTObject *> *> *)fetchAllInBackground:(nullable NSArray<RTObject *> *)objects;
 ...
 */
+ (void)fetchAllInBackground:(nullable NSArray<RTObject *> *)objects
                       block:(nullable RTArrayResultBlock)block;
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
+ (BFTask<NSArray<__kindof RTObject *> *> *)fetchAllIfNeededInBackground:(nullable NSArray<RTObject *> *)objects;

/**
 Fetches all of the RTObjects with the current data from the server *asynchronously*
 and calls the given block.
 ...
 It should have the following argument signature: `^(NSArray *objects, NSError *error)`.
 */
+ (void)fetchAllIfNeededInBackground:(nullable NSArray<RTObject *> *)objects
                               block:(nullable RTArrayResultBlock)block;
 ...
 *Asynchronously* loads data from the local datastore into this object,
 ...
 @return The task that encapsulates the work being done.
 */
- (BFTask<__kindof RTObject *> *)fetchFromLocalDatastoreInBackground;
 ...
 *Asynchronously* loads data from the local datastore into this object,
 ...
 It should have the following argument signature: `^(RTObject *object, NSError *error)`.
 */
- (void)fetchFromLocalDatastoreInBackgroundWithBlock:(nullable RTObjectResultBlock)block;
...
/**
 Deletes the `RTObject` *asynchronously*.
...
/**
 Deletes the `RTObject` *asynchronously* and executes the given callback block.
...
/**
 ...
 to Rooftop. They will be sent immediately if possible. Otherwise, they will be sent the next time a network connection
 ...
 @return The task that encapsulates the work being done.
 */
- (BFTask<NSNumber *> *)deleteEventually RT_TV_UNAVAILABLE RT_WATCH_UNAVAILABLE;
 ...
 *Asynchronously* stores the object and every object it points to in the local datastore, recursively,
 ...
 @see `RTObjectDefaultPin`
 */
- (void)pinInBackgroundWithBlock:(nullable RTBooleanResultBlock)block;
 ...
 */
- (void)pinInBackgroundWithName:(NSString *)name block:(nullable RTBooleanResultBlock)block;
 ...
 *Asynchronously* stores the objects and every object they point to in the local datastore, recursively,
 ...
 @see RTObjectDefaultPin
 */
+ (BFTask<NSNumber *> *)pinAllInBackground:(nullable NSArray<RTObject *> *)objects;
 ...
 *Asynchronously* stores the objects and every object they point to in the local datastore, recursively,
 ...
 @see RTObjectDefaultPin
 */
+ (void)pinAllInBackground:(nullable NSArray<RTObject *> *)objects block:(nullable RTBooleanResultBlock)block;
 ...
 */
+ (BFTask<NSNumber *> *)pinAllInBackground:(nullable NSArray<RTObject *> *)objects withName:(NSString *)name;
 ...
 */
+ (void)pinAllInBackground:(nullable NSArray<RTObject *> *)objects
 ...
 *Asynchronously* removes the object and every object it points to in the local datastore, recursively,
 ...
 @see RTObjectDefaultPin
 */
- (void)unpinInBackgroundWithBlock:(nullable RTBooleanResultBlock)block;
 ...
 */
- (void)unpinInBackgroundWithName:(NSString *)name block:(nullable RTBooleanResultBlock)block;
 ...
 *Asynchronously* removes all objects in the local datastore
 ...
 @see RTObjectDefaultPin
 */
+ (void)unpinAllObjectsInBackgroundWithBlock:(nullable RTBooleanResultBlock)block;
 ...
 *Asynchronously* removes all objects with the specified pin name.
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
+ (void)unpinAllObjectsInBackgroundWithName:(NSString *)name block:(nullable RTBooleanResultBlock)block;
 ...
 *Asynchronously* removes the objects and every object they point to in the local datastore, recursively,
 ...
 @see RTObjectDefaultPin
 */
+ (BFTask<NSNumber *> *)unpinAllInBackground:(nullable NSArray<RTObject *> *)objects;
 ...
 *Asynchronously* removes the objects and every object they point to in the local datastore, recursively,
 ...
 @see RTObjectDefaultPin
 */
+ (void)unpinAllInBackground:(nullable NSArray<RTObject *> *)objects block:(nullable RTBooleanResultBlock)block;
 ...
 */
+ (BFTask<NSNumber *> *)unpinAllInBackground:(nullable NSArray<RTObject *> *)objects withName:(NSString *)name;
 ...
 */
+ (void)unpinAllInBackground:(nullable NSArray<RTObject *> *)objects
                    withName:(NSString *)name
                       block:(nullable RTBooleanResultBlock)block;
