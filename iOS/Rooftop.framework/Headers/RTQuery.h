...
/**
 The `RTQuery` class defines a query that is used to query for `RTObject`s.
 */
@interface RTQuery<RTGenericObject : RTObject *> : NSObject<NSCopying>

///--------------------------------------
#pragma mark - Blocks
///--------------------------------------

typedef void (^RTQueryArrayResultBlock)(NSArray<RTGenericObject> *_Nullable objects, NSError * _Nullable error);
...
/**
 Returns a `RTQuery` for a given class.

 @param className The class to query on.

 @return A `RTQuery` object.
 */
+ (instancetype)queryWithClassName:(NSString *)className;

/**
 Creates a RTQuery with the constraints given by predicate.
 ...
 */
@property (nonatomic, strong) NSString *rooftopClassName;
...
/**
 Make the query include `RTObject`s that have a reference stored at the provided key.
 ...
 @param key The key to load child `RTObject`s for.

 @return The same instance of `RTQuery` as the receiver. This allows method chaining.
 */
- (instancetype)includeKey:(NSString *)key;

/**
 Make the query include `RTObject`s that have a reference stored at the provided keys.
 
 @param keys The keys to load child `RTObject`s for.
...
/**
 Make the query restrict the fields of the returned `RTObject`s to include only the provided keys.
...
/**
 Add a constraint to the query that requires a particular key's coordinates (specified via `RTGeoPoint`)
 ...
 @param key The key to be constrained.
 @param geopoint The reference point represented as a `RTGeoPoint`.

 @return The same instance of `RTQuery` as the receiver. This allows method chaining.
 */
- (instancetype)whereKey:(NSString *)key nearGeoPoint:(RTGeoPoint *)geopoint;
...
- (instancetype)whereKey:(NSString *)key
            nearGeoPoint:(RTGeoPoint *)geopoint
...
/**
 Add a constraint to the query that requires a particular key's coordinates (specified via `RTGeoPoint`) be near
 ...
 @param key The key to be constrained.
 @param geopoint The reference point as a `RTGeoPoint`.
...
/**
 Add a constraint to the query that requires a particular key's coordinates (specified via `RTGeoPoint`) be
 ...
 @return The same instance of `RTQuery` as the receiver. This allows method chaining.
 */
- (instancetype)whereKey:(NSString *)key withinGeoBoxFromSouthwest:(RTGeoPoint *)southwest toNortheast:(RTGeoPoint *)northeast;
...
/**
 Returns a `RTQuery` that is the `or` of the passed in queries.

 @param queries The list of queries to or together.

 @return An instance of `RTQuery` that is the `or` of the passed in queries.
 */
+ (instancetype)orQueryWithSubqueries:(NSArray<RTQuery *> *)queries;
...
/**
 Add a constraint that requires that a key's value matches a `RTQuery` constraint.

 @warning This only works where the key's values are `RTObject`s or arrays of `RTObject`s.
 ...
 @return The same instance of `RTQuery` as the receiver. This allows method chaining.
 */
- (instancetype)whereKey:(NSString *)key matchesQuery:(RTQuery *)query;

/**
 Add a constraint that requires that a key's value to not match a `RTQuery` constraint.
 ...
 @return The same instance of `RTQuery` as the receiver. This allows method chaining.
 */
- (instancetype)whereKey:(NSString *)key doesNotMatchQuery:(RTQuery *)query;
...
/**
 Gets a `RTObject` asynchronously and calls the given block with the result.
 ...
 */
- (BFTask<RTGenericObject> *)getObjectInBackgroundWithId:(NSString *)objectId;
...
- (void)getObjectInBackgroundWithId:(NSString *)objectId
                              block:(nullable void (^)(RTGenericObject _Nullable object, NSError *_Nullable error))block;
...
/**
 Finds objects *asynchronously* and sets the `NSArray` of `RTObject` objects as a result of the task.

 @return The task, that encapsulates the work being done.
 */
- (BFTask<NSArray<RTGenericObject> *> *)findObjectsInBackground;
 ...
 */
- (void)findObjectsInBackgroundWithBlock:(nullable RTQueryArrayResultBlock)block;
...
/**
 ...
 @return The task, that encapsulates the work being done.
 */
- (BFTask<RTGenericObject> *)getFirstObjectInBackground;
 ...
 */
- (void)getFirstObjectInBackgroundWithBlock:(nullable void (^)(RTGenericObject _Nullable object, NSError *_Nullable error))block;
 ...
 */
- (void)countObjectsInBackgroundWithBlock:(nullable RTIntegerResultBlock)block;
...
/**
 ...
 @see fromPinWithName:
 */
@property (nonatomic, assign) RTCachePolicy cachePolicy;
